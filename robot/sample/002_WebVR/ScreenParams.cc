...
void ScreenParams::SetVarIndicator(
...
void ScreenParams::GetOnlineSetVars(
...
void ScreenParams::SetOnlineSetVars(
...
void ScreenParams::SetOnlineSetVar(const unsigned int VarNum,
                                   const double VarVal) {
  setWriteVariable(VarNum, VarVal);
}

void ScreenParams::UpdateOnlineSetVar() { GetOnlineSetVars(OnlineSetVar); }
